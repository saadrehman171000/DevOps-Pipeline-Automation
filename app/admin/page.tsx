              ...
              <Sheet open={isSidebarOpen} onOpenChange={setIsSidebarOpen}>
                ...
                <SheetContent side="left" className="w-[300px] sm:w-[400px]">
                  <SheetHeader>
                    ...
                    <SheetDescription>
                      Navigate through different sections of the admin
                      dashboard.
                    </SheetDescription>
                  </SheetHeader>
        ...
        <main className="container mx-auto px-4 py-8 flex-grow">
          ...
          >
            <TabsList className="grid grid-cols-4 gap-4 bg-transparent">
              <TabsTrigger
                value="dashboard"
                className="data-[state=active]:bg-white data-[state=active]:shadow-md dark:data-[state=active]:bg-gray-800"
              >
                <BarChart2 className="mr-2 h-4 w-4" />
                Dashboard
              </TabsTrigger>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <Card>
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">
                      <span className="text-green-500">↑</span> 20.1% from last
                      month
                    </p>
                  </CardContent>
                </Card>
                <Card>
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">
                      <span className="text-green-500">↑</span> 180.1% from last
                      month
                    </p>
                  </CardContent>
                </Card>
                <Card>
                  ...
                  <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground">
                      <span className="text-green-500">↑</span> 201 since last
                      hour
                    </p>
                  </CardContent>
                </Card>
