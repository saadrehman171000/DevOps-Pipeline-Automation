  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'dark' : ''}`}>
      <div className="bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 text-gray-900 dark:text-gray-100 transition-colors duration-300">
        {/* Navbar */}
        <nav
          className={`fixed w-full z-50 transition-all duration-300 ${scrollY > 0 ? 'bg-white/80 dark:bg-gray-800/80 backdrop-blur-md shadow-md' : 'bg-transparent'}`}
        >
                  ...
                  {['About', 'Features', 'Testimonials', 'Contact'].map(
                    (item) => (
                      <Link
                        key={item}
                        href={`#${item.toLowerCase()}`}
                        className="text-lg font-medium hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-300"
                      >
                        {item}
                      </Link>
                    ),
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="lg:text-center">
              ...
              <p className="mt-4 max-w-2xl text-xl text-gray-500 dark:text-gray-400 lg:mx-auto">
                ...
                tools that streamline operations, enhance collaboration, and
                drive sustainable growth in the ever-evolving textile sector.
              </p>
            </div>
              ...
              <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                {[
                  ...
                  },
                  {
                    ...
                    description:
                      'Providing instant insights and data-driven decision making capabilities.',
                    icon: MessageCircle,
                  },
                ].map((feature) => (
        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="lg:text-center">
              ...
              <p className="mt-4 max-w-2xl text-xl text-gray-500 dark:text-gray-400 lg:mx-auto">
                FiberFlow provides a comprehensive suite of tools to streamline
                your textile production process from start to finish.
              </p>
            </div>
              ...
              <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                {[
                  ...
                  },
                  {
                    ...
                    description:
                      'Streamline your supply chain with our integrated management tools.',
                    icon: ArrowRight,
                  },
                  {
                    name: 'Quality Control',
                    description:
                      'Ensure consistent quality with our advanced quality control features.',
                    icon: CheckCircle,
                  },
                ].map((feature, index) => (
                  <motion.div
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="col-span-1 md:col-span-2">
                ...
                <p className="mt-4 text-base text-gray-300">
                  Digitalizing the textile industry with innovative PLM
                  solutions.
                </p>
              </div>
              <div>
