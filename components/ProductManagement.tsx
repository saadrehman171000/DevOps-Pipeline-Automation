    ...
    <ScrollArea className="h-[60vh] pr-4">
      <div className="grid gap-4 py-4">
        <div className="grid grid-cols-4 items-center gap-4">
          <Label
            htmlFor={isEditing ? 'edit-name' : 'name'}
        ...
        <div className="grid grid-cols-4 items-center gap-4">
          <Label
            htmlFor={isEditing ? 'edit-style' : 'style'}
            className="text-right"
          >
            Style
          </Label>
        ...
        <div className="grid grid-cols-4 items-center gap-4">
          <Label
            htmlFor={isEditing ? 'edit-fabric' : 'fabric'}
            className="text-right"
          >
            Fabric
          </Label>
          <Input
            ...
            onChange={(e) =>
              isEditing
                ...
                : setNewProduct({ ...newProduct, fabric: e.target.value })
            }
            className="col-span-3"
          />
        </div>
        <div className="grid grid-cols-4 items-center gap-4">
          <Label
            htmlFor={isEditing ? 'edit-vendor' : 'vendor'}
            className="text-right"
          >
            Vendor
          </Label>
          ...
          <div className="col-span-3 space-y-2">
            {sizes.map((size) => (
              <div key={size} className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor={`${isEditing ? 'edit-' : ''}size-${size}`}>
                  {size}
                </Label>
        ...
        <div className="grid grid-cols-4 items-center gap-4">
          <Label
            htmlFor={isEditing ? 'edit-poDate' : 'poDate'}
            className="text-right"
          >
            PO Date
          </Label>
          <Input
            ...
            onChange={(e) =>
              isEditing
                ...
                : setNewProduct({ ...newProduct, poDate: e.target.value })
            }
            className="col-span-3"
          />
        </div>
        <div className="grid grid-cols-4 items-center gap-4">
          <Label
            htmlFor={isEditing ? 'edit-image' : 'image'}
            className="text-right"
          >
            Image (Optional)
          </Label>
